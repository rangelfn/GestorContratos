...
public partial class GestorContratosContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Edital>(entity =>
        {
            ...
            entity.Property(e => e.EditalTipo)
                .HasMaxLength(255)
                .IsUnicode(false);
        ...
        modelBuilder.Entity<PagamentosTipo>(entity =>
        {
            ...
            entity.Property(e => e.NotaEmpenho)
                .HasMaxLength(255)
                .IsUnicode(false);
            entity.Property(e => e.PagamentoId).HasColumnName("PagamentoID");
            ...
            entity.HasOne(d => d.Pagamento).WithMany(p => p.PagamentosTipos)
                ...
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("FK__Pagamento__Pagam__1DB06A4F");
        });
        ...
        modelBuilder.Entity<PessoasPortaria>(entity =>
        {
            ...
            entity.Property(e => e.FuncaoPessoa)
                .HasMaxLength(255)
                .IsUnicode(false);
            entity.Property(e => e.PessoaId).HasColumnName("PessoaID");
            entity.Property(e => e.PortariaId).HasColumnName("PortariaID");
            entity.Property(e => e.TipoPortaria)
                .HasMaxLength(255)
                .IsUnicode(false);
        ...
        modelBuilder.Entity<ViewContratosPagamento>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("ViewContratosPagamentos");
        ...
        modelBuilder.Entity<ViewEditaisPorContrato>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("ViewEditaisPorContratos");
        ...
        modelBuilder.Entity<ViewPagamentosTotalPorContrato>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("ViewPagamentosTotalPorContrato");
            ...
            entity.Property(e => e.Modalidade)
                .HasMaxLength(255)
                .IsUnicode(false);
            entity.Property(e => e.NotasLancamento)
                .HasMaxLength(8000)
                .IsUnicode(false);
            entity.Property(e => e.Objeto)
                .HasMaxLength(4000)
        ...
        modelBuilder.Entity<VwContratosPagamento>(entity =>
        {
            ...
            entity.Property(e => e.Modalidade)
                .HasMaxLength(255)
                .IsUnicode(false);
            entity.Property(e => e.ModalidadePagamento)
                .HasMaxLength(255)
                .IsUnicode(false);
            entity.Property(e => e.NotaEmpenho)
                .HasMaxLength(255)
        ...
        modelBuilder.Entity<VwPortariasPorContrato>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vwPortariasPorContratos");
