...
namespace GestorContratos.Controllers
{
    public class AditivosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AditivoId,Numero,Descricao,DataInicio,DataFim,Valor,ContratoId")] Aditivo aditivo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AditivoId,Numero,Descricao,DataInicio,DataFim,Valor,ContratoId")] Aditivo aditivo)
        {
